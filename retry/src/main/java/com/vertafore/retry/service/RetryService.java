...
package com.vertafore.retry.service;

import com.vertafore.retry.repository.RetryRepository;
...
public class RetryService {
    ...
    public String getRetryData() {
        numCalls++;
        System.out.println("This is service. Service numCalls = " + numCalls);
        return retryRepository.retryDatabaseCall();
    }
}
