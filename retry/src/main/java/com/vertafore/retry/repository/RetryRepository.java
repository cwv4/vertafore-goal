...
package com.vertafore.retry.repository;
...
public class RetryRepository {
    ...
    public String retryDatabaseCall() {
        ...
        System.out.println("This is retry repository data. For your info, repository numCalls = " + numCalls);
        return "This is retry repository data. For your info, repository numCalls = " + numCalls;
    }
}
